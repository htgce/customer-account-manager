package com.abnambro.customer.account.manager.security.jwt;
...
public class JwtUtils {
    ...
    public String generateJwtToken(CustomUserDetails customUserDetails) {
        ...
        claims.put(TokenClaims.USERNAME.getValue(), customUserDetails.getUsername());
    ...
    public String getUsernameFromToken(String token) {
        String idValue = extractClaims(token).get(TokenClaims.USERNAME.getValue()).toString();
        return idValue;
    }
